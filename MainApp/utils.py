...
def generate_ticket_no(cid: str = '0', fsktm_name: str = '') -> str:
    if cid is None:
        return f'{fsktm_name}00001'
    if len(cid) == 1:
        return f'{fsktm_name}0000{cid}'
    elif len(cid) == 2:
        return f'{fsktm_name}000{cid}'
    elif len(cid) == 3:
        return f'{fsktm_name}00{cid}'
    elif len(cid) == 4:
        return f'{fsktm_name}0{cid}'
    else:
        return f'{fsktm_name}{cid}'
